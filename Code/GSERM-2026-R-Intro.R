...
setwd("~/Dropbox (Personal)/GSERM/Panel-2026/Data")
...
SCOTUS <- read.csv("https://github.com/PrisonRodeo/GSERM-Panel-2026/raw/main/Data/SCOTUS-votes.csv")
